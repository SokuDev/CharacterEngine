...
#define maxRabbits(tewi) (2 + tewi->effectiveSkillLevel[6])
...
private:
	...
	static constexpr float HIGH_JUMP_SPEED_X = 9;
	static constexpr float N_HIGH_JUMP_FD_SPEED_X = 3;
	static constexpr float F_HIGH_JUMP_FD_SPEED_X = 11;
	...
	static constexpr float HAMMER_HIGH_JUMP_SPEED_Y = 18;
	...
	static constexpr float FAD_SPEED_X = 11;
	static constexpr float FAD_SPEED_Y = 4;
	static constexpr float FAD_GRAVITY = 0.5;
	...
	static constexpr float HAMMER_B_BULLET_SLOW_DOWN = 0.35;
...
public:
	enum Moves {
		...
		ACTION_ja1_236B_HAMMER =                 546,
		ACTION_ja1_236C_HAMMER =                 547,
		ACTION_a1_214B =                         548,
		ACTION_a1_214C =                         549,
		ACTION_ja1_214C =                        551,
		...
		ACTION_HANGEKI_HAMMER =                  699,
		ACTION_LEFT_HANDED_FOLDING_FAN_HAMMER =  700,
		ACTION_SPELL_BREAKING_DRUG_HAMMER =      701,
